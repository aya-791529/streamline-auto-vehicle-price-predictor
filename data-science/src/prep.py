...
if __name__ == "__main__":
    ...
    # Parse Arguments
    args = parse_arguments()  # Call the function to parse arguments

    lines = [
        f"Raw data path: {args.train_data}",  # Print the raw_data path
        ...
        f"Test-train ratio: {args.0.2}",  # Print the test_train_ratio
    ]
